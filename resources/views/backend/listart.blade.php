...
@inject('myclass', 'App\Libraries\myclass')
      ...
      <a href="<?php echo url('/art/addArt'); ?>" class="btn btn-primary"><i class="menu-icon icon-plus"></i> Create Article</a>
      </div>
      <br />
      <br />
 ...
 <tr>
  ...
  <ul class="dropdown-menu" role="menu">
    <li><a href="<?php echo asset('art/editArt').'/'.$row->id_artikel; ?>"><i class="menu-icon icon-edit"></i> Edit</a></li>
    <li><a title="Delete Article <?php echo $row->id_artikel; ?> - <?php echo $row->summary; ?>" href="<?php echo asset('art/delArt').'/'. $row->id_artikel; ?>" id="confirm"><i class="menu-icon icon-trash"></i> Delete</a></li>
  </ul>
</div>
    </td>
 </tr>
